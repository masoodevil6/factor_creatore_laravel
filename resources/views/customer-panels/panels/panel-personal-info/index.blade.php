<section id="inside-panel-view" data-panel="{{$titleEn}}">
    ...
    {{--@include("customer-panel.panels.top-title-panel")
    ...
    @if(Auth::user()->email == "" || Auth::user()->phone == "")
        ...
        <meta name="url-send-email-or-phone-client" content="{{ route("panel.persional-info.send-verify-phone-or-email") }}" />
        <meta name="url-verify-email-or-phone-client" content="{{ route("panel.persional-info.verify-phone-or-email") }}" />
